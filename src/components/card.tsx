...
const ProductCard = ({ title, price, image, description, category }: any) => {
  return (
    <div className="flex flex-col bg-white rounded-2xl shadow-[4px_4px_6px_rgba(0,0,0,0)]  shadow-gray-400/50 w-full sm:w-80 lg:w-70 xl:w-70 2xl:w-86 mb-2">
      ...
      <div
        ...
        } text-white pt-3 pb-6 rounded-2xl flex-1`}
      >
